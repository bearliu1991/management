...
<script>
/**
 * getTStatusTableById 不知道 tableName
 */
...
import filterTable from '@/components/syscomponents/filterTable.vue'
  export default {
    ...
    data () {
        ...
        return {
            urls: {
                getList: self.Path.getTStatusListByPage,
                getItem: self.Path.getTStatusById,
                add: self.Path.saveOrUpdateTStatus,
                update: self.Path.saveOrUpdateTStatus,
                delete: self.Path.delTStatusById,
