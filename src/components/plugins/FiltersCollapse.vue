            ...
            <Panel name="1">
                ...
                <div slot="content">
                    <div class="filter-container">
                        <div v-if="Array.isArray(FilterItem.filters)"  v-for=" (item, index) in  FilterItem.filters" :key='"filters"+index' class="itemSelect">
                    ...
                    <div class="filter-btns">
                        ...
                        <span @click="resetFilter" class="cursor">清空筛选条件</span>
                    </div>
                </div>
            </Panel>
        </Collapse>
